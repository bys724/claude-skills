...
**원칙: 단순 환율 변환(USD × 환율) 절대 금지. 반드시 실제 국내 판매가를 조사할 것.**
- 한국 유통 가격은 수입 관세, 유통 마진, VAT 등으로 해외가와 크게 다름
- 환율 추정치는 오차가 너무 커서 참고 가치 없음
...
**조사 우선순위:**
1. **다나와 최저가** — 국내 가격 비교의 기준점
2. **쿠팡/네이버쇼핑** — 실제 구매 가능 가격
3. **공식 대리점/전문몰** — 정가 및 A/S 보장 가격
4. **해외직구** (Amazon, AliExpress 등) — 국내 미출시 or 가격차 클 때만

**가격 표기 방식:**
- 국내 판매가가 있으면: `₩XXX,XXX (다나와 최저가)` 형태로 출처 명시
- 국내 미출시 제품: `해외직구 $XXX (약 ₩XXX,XXX)` — 이 경우에만 환율 변환 허용, 관부가세 별도 명시
- 국내가와 해외직구가 모두 있으면: 둘 다 병기하고 차이 설명
...
### 한국 시장 우선
- **국내 구매처** 우선 조사 (다나와, 쿠팡, 네이버쇼핑, 전문몰, 공식 대리점)
- **⚠️ 실제 원화 판매가 필수** — USD 환율 변환으로 대체 금지
- 다나와 최저가 or 쿠팡 실제 판매가를 기준으로 가격 제시
- 국내 미출시 제품만 해외직구 가격 사용 (관부가세 별도 안내)
- **국산 브랜드** 있으면 함께 고려
- 구매처별 가격 비교 + URL 제공
